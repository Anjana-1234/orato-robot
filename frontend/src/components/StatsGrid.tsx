...
function AnimatedNumber({ value, suffix = '' }: { value: number; suffix?: string }) {
  ...
  return (
    <span ref={numberRef} className="text-3xl font-bold text-gray-900 font-heading">
      ...
      {stats.map((stat, index) => {
        ...
        return (
          <div
            ...
            className="bg-white rounded-2xl p-5 card-shadow transition-shadow duration-300 cursor-pointer relative overflow-hidden"
            style={{ 
          ...
          >
            ...
            <div className="flex items-start justify-between">
              <div className={`w-12 h-12 rounded-xl ${stat.iconBg} flex items-center justify-center transition-transform duration-300 ${isHovered ? 'scale-110' : ''}`}>
